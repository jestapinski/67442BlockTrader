...
/** Saturday (1-4B) and Sunday (5-8)'s Plan of attack for Phase 1 and 2
 ...
 7. Process redirect using logic and get needed elements saved to DB ABLE
 8. Display Home Screen (Allow for custom Redirect URI and use a custom Segue) DONE
 */

/** Phase 3 Plan of Attack - SUN to TUE
 SUN - Get username back from stripe using server DONE
 MON-*TUE* Create user and get user_id through using a credit card.
 TUE-WED Charge Framework
 1. Hardcode two users
 2. Get back their stripe_IDs using phase 1 and 2 and save DONE
 MON and TUE - Charge Framework
